...
namespace Sleek.DataAccess.Core
{
    public interface IQueryDataGateway 
    {
        ...
        /// <summary>
        /// Executes a SELECT query with an optional setup action to configure the SqlCommand and returns the first column of the first row in the result set, or a DBNull if no rows are found.
        /// </summary>
        /// <param name="query">The SELECT query to be executed.</param>
        ...
        /// <summary>
        /// Executes a SELECT query with an input parameter and an optional setup action to configure the SqlCommand and set the input parameter, and returns the first column of the first row in the result set, or a DBNull if no rows are found.
        /// </summary>
        /// <param name="query">The SELECT query to be executed.</param>
        /// <param name="input">The input parameter to be passed to the query.</param>
        /// <param name="Setup">An optional action to configure the SqlCommand and set the input parameter before execution.</param>
        /// <returns>An object representing the first column of the first row in the result set, or a DBNull if no rows are found.</returns>
        ...
        /// <summary>
        /// Executes a SELECT query with an optional setup action to configure the SqlCommand and returns a single result of type TOutput.
        /// </summary>
        /// <typeparam name="TOutput">The type of the expected result.</typeparam>
        /// <param name="query">The SELECT query to be executed.</param>
        /// <param name="Setup">An optional action to configure the SqlCommand before execution.</param>
        ...
        /// <summary>
        /// Executes a SELECT query with input parameters of type TInput and an optional setup action to configure the SqlCommand, and returns a single result of type TOutput.
        /// </summary>
        ...
        /// <param name="Setup">An optional action to configure the SqlCommand with the input parameters before execution.</param>
        /// <returns>A single result of type TOutput or default(TOutput) if no result is found.</returns>
        ...
        /// <summary>
        /// Executes a SELECT query with an optional setup action to configure the SqlCommand, and maps the result to an object of type TOutput using a provided Mapper function.
        /// </summary>
        /// <typeparam name="TOutput">The type of the expected result.</typeparam>
        /// <param name="Query">The SELECT query to be executed.</param>
        /// <param name="Setup">An optional action to configure the SqlCommand before execution.</param>
        ...
        /// <summary>
        /// Executes a SELECT query with input parameters of type TInput and an optional setup action to configure the SqlCommand, and maps the result to an object of type TOutput using a provided Mapper function.
        /// </summary>
        /// <typeparam name="TInput">The type of the input parameters.</typeparam>
        /// <typeparam name="TOutput">The type of the expected result.</typeparam>
        /// <param name="Query">The SELECT query to be executed.</param>
        ...
        /// <summary>
        /// Executes a write (INSERT, UPDATE, DELETE) query with an optional setup action to configure the SqlCommand and returns the number of rows affected.
        /// </summary>
        /// <param name="query">The write query to be executed.</param>
        /// <param name="Setup">An optional action to configure the SqlCommand before execution.</param>
        /// <returns>The number of rows affected by the query execution.</returns>
